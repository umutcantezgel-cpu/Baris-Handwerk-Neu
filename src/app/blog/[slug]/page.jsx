    ...
    <div className="min-h-screen bg-gray-50/50">
      ...
      <div className="relative pt-[var(--spacing-32)] pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-[#1a3a52] z-0">
          ...
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#c69c6d]/20 rounded-full blur-[100px] animate-pulse" />
        </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-white/80 text-sm md:text-base bg-white/5 backdrop-blur-sm inline-flex px-6 py-3 rounded-2xl border border-white/10">
              <div className="flex items-center gap-2">
                <Calendar className="w-5 h-5 text-[#c69c6d]" />
              ...
              <div className="flex items-center gap-2">
                <Clock className="w-5 h-5 text-[#c69c6d]" />
          ...
          <main className="lg:col-span-9 xl:col-span-8">
            ...
            <div className="relative mb-12">
              ...
              <div className="relative p-8 md:p-12">
                ...
                {/* Excerpt */}
                <p className="text-xl md:text-2xl text-[#1a3a52] font-medium leading-relaxed mb-12 border-l-4 border-[#c69c6d] pl-8 italic">
                  {post.excerpt}
                </p>

                {/* Markdown Content */}
                <div className="prose prose-lg max-w-none prose-headings:text-[#1a3a52] prose-headings:scroll-mt-32 prose-p:text-[#2c3e50]/80 prose-a:text-[#c69c6d] prose-a:font-medium prose-strong:text-[#1a3a52] prose-li:text-[#2c3e50]/80">
                  <ReactMarkdown
                    ...
                    components={{
                      ...
                      h3: ({ node, ...props }) => <h3 id={generateSlug(props.children)} className="text-xl font-bold mt-10 mb-4 text-[#c69c6d]" {...props} />,
                      ul: ({ node, ...props }) => <ul className="list-disc pl-6 mb-6 space-y-2 marker:text-[#c69c6d]" {...props} />,
                      ol: ({ node, ...props }) => <ol className="list-decimal pl-6 mb-6 space-y-2 marker:text-[#c69c6d] marker:font-bold" {...props} />,
                      blockquote: ({ node, ...props }) => <blockquote className="border-l-4 border-[#c69c6d] bg-[#c69c6d]/5 pl-6 py-5 my-8 rounded-r-xl italic text-gray-700" {...props} />,
                      img: ({ node, ...props }) => (
                        <div
                  ...
                  <div className="mt-16 pt-8 border-t border-gray-100">
                    <div className="flex flex-wrap gap-2">
                      {post.tags.map((tag, index) => (
                        <Badge key={index} variant="secondary" className="bg-gray-100 text-[#2c3e50] hover:bg-[#c69c6d] hover:text-white px-3 py-1 text-sm transition-colors cursor-pointer">
                ...
                <div className="mt-12 flex flex-col sm:flex-row items-center justify-between gap-6 p-6 bg-gray-50 rounded-2xl border border-gray-100">
                  <div className="flex items-center gap-4">
                    ...
                    <Button
                      ...
                      onClick={handleVote}
                      disabled={hasVoted}
                      className={`gap-2 ${hasVoted ? "bg-[#c69c6d] hover:bg-[#c69c6d]" : "hover:text-[#c69c6d] hover:border-[#c69c6d]"}`}
                    >
                ...
                {/* PDF Download */}
                {post.download_url && (
                  <div className="mt-8 p-6 bg-gradient-to-r from-[#c69c6d]/10 to-[#1a3a52]/5 rounded-2xl border border-[#c69c6d]/20 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center text-[#c69c6d]">
                    ...
                    <Button className="bg-[#c69c6d] hover:bg-[#a67c52] text-white shadow-lg shadow-[#c69c6d]/30 w-full sm:w-auto">
                      Download PDF
                    </Button>
                  </div>
                )}
            ...
            {post.related_service && (
              <div className="mb-12 relative overflow-hidden rounded-[2.5rem] shadow-2xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-[#1a3a52] to-[#c69c6d] opacity-90" />
                {/* Decorative circles */}
                ...
                <div className="relative p-10 md:p-14 text-center text-white">
                  ...
                  <p className="text-lg text-white/80 mb-10 max-w-2xl mx-auto leading-relaxed">
                    Unsere Experten für <strong className="text-white border-b border-[#c69c6d]">{post.related_service}</strong> stehen Ihnen für eine individuelle Beratung zur Verfügung.
                  </p>
