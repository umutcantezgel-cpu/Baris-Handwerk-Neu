...
const Beratung = () => {
    return (
        <>
            <Helmet>
                <title>{`Beratungstermin buchen | ${COMPANY_DATA.legalName}`}</title>
                <meta
                    name="description"
                    content="Buchen Sie jetzt Ihren kostenlosen Beratungstermin bei Batherm Haustechnik. Wir beraten Sie zu Sanitär, Heizung und Solartechnik in Wetzlar und Umgebung."
                />
            </Helmet>
